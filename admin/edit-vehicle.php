<?php
   ...
   if(isset($_GET['id'])){
	$id=$_GET['id'];	
	$sql ="SELECT cars.*,brands.BrandName,brands.id AS bid FROM cars JOIN brands ON brands.id=cars.VehiclesBrand WHERE cars.id='$id'";
	$res= mysqli_query($con,$sql);
	$row=mysqli_fetch_assoc($res);
	$id=$row['id'];
	$vehicletitle=$row['VehiclesTitle'];
	$vehicleoverview=$row['VehiclesOverview'];
	$priceperday=$row['PricePerDay'];
	$fueltype=$row['FuelType'];
	$modelyear=$row['ModelYear'];
	$seatingcapacity=$row['SeatingCapacity'];
	$airconditioner=$row['AirConditioner'];
	$powerdoorlocks=$row['PowerDoorLocks'];
	$antilockbrakingsys=$row['AntiLockBrakingSystem'];
	$brakeassist=$row['BrakeAssist'];
	$powersteering=$row['PowerSteering'];
	$driverairbag=$row['DriverAirbag'];
	$passengerairbag=$row['PassengerAirbag'];
	$powerwindow=$row['PowerWindows'];
	$cdplayer=$row['CDPlayer'];
	$centrallocking=$row['CentralLocking'];
	$crashcensor=$row['CrashSensor'];
	$leatherseats=$row['LeatherSeats'];
	$Vimage1=$row['Vimage1'];
	$Vimage2=$row['Vimage2'];
	$Vimage3=$row['Vimage3'];
	$Vimage4=$row['Vimage4'];
   ...
   $sql="update cars set VehiclesTitle='$vehicletitle',VehiclesBrand='$brand',VehiclesOverview='$vehicleoverview',PricePerDay='$priceperday',FuelType='$fueltype',ModelYear='$modelyear',SeatingCapacity='$seatingcapacity',AirConditioner='$airconditioner',PowerDoorLocks='$powerdoorlocks',AntiLockBrakingSystem='$antilockbrakingsys',BrakeAssist='$brakeassist',PowerSteering='$powersteering',DriverAirbag='$driverairbag',PassengerAirbag='$passengerairbag',PowerWindows='$powerwindow',CDPlayer='$cdplayer',CentralLocking='$centrallocking',CrashSensor='$crashcensor',LeatherSeats='$leatherseats' where id='$id' ";
   $res=mysqli_query($con,$sql);
   if($res){
...
<html lang="en" class="no-js">
   ...
   <body>
      ...
      <div class="col-md-12">
                  ...
                  <div class="panel-body">
                     ...
                     <form method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group">
                           ...
                           <div class="col-sm-4">
                              <input type="text" name="vehicletitle" class="form-control" value="<?php echo $vehicletitle;?>" required>
                           </div>
                                 ...
                                 <?php
                                    ...
                                    while ($row=mysqli_fetch_assoc($res)) {
                                       ...
                                       if ($row['id']==$categories_id) {
                                          echo "<option selected value=".$row['id'].">".$row['BrandName']."</option>";   
                                       }else{
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <textarea class="form-control" name="vehicalorcview" rows="3" required><?php echo $vehicleoverview;?></textarea>
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="col-sm-2 control-label">Price Per Day(in USD)<span style="color:red">*</span></label>
                           <div class="col-sm-4">
                              <input type="text" name="priceperday" class="form-control" value="<?php echo $priceperday;?>" required>
                           </div>
                           <label class="col-sm-2 control-label">Select Fuel Type<span style="color:red">*</span></label>
                           <div class="col-sm-4">
                              <select class="selectpicker" name="fueltype" required>
                                 <option value="<?php echo $row['FuelType'];?>"> <?php echo $fueltype;?> </option>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-4">
                              <input type="text" name="modelyear" class="form-control" value="<?php echo $modelyear;?>" required>
                           </div>
                           <label class="col-sm-2 control-label">Seating Capacity<span style="color:red">*</span></label>
                           <div class="col-sm-4">
                              <input type="text" name="seatingcapacity" class="form-control" value="<?php echo $seatingcapacity;?>" required>
                           </div>
                        </div>
                        <div class="hr-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           <div class="col-sm-4">
                              Image 1 <img src="img/vehicleimages/<?php echo $Vimage1;?>" width="300" height="200" style="border:solid 1px #000">
                              <a href="changeimage1.php?imgid=<?php echo $id?>">Change Image 1</a>
                           </div>
                           <div class="col-sm-4">
                              Image 2<img src="img/vehicleimages/<?php echo $Vimage2;?>" width="300" height="200" style="border:solid 1px #000">
                              <a href="changeimage2.php?imgid=<?php echo $id?>">Change Image 2</a>
                           </div>
                           <div class="col-sm-4">
                              Image 3<img src="img/vehicleimages/<?php echo $Vimage3;?>" width="300" height="200" style="border:solid 1px #000">
                              <a href="changeimage3.php?imgid=<?php echo $id?>">Change Image 3</a>
                           </div>
                        </div>
                        <div class="form-group">
                           <div class="col-sm-4">
                              Image 4<img src="img/vehicleimages/<?php echo $Vimage4;?>" width="300" height="200" style="border:solid 1px #000">
                              <a href="changeimage4.php?imgid=<?php echo $id?>">Change Image 4</a>
                           </div>
                           <div class="col-sm-4">
                              Image 5
                              <?php if($row['Vimage5']=="")
                              ...
                              <img src="img/vehicleimages/<?php echo $$Vimage5;?>" width="300" height="200" style="border:solid 1px #000">
                              <a href="changeimage5.php?imgid=<?php echo $id?>">Change Image 5</a>
                              <?php } ?>
                           </div>
                        </div>
                        <div class="hr-dashed"></div>
         ...
         <label for="inlineCheckbox3"> 	CD Player </label>
         </div>
         <?php } else { ?>
         <div class="checkbox checkbox-inline">
